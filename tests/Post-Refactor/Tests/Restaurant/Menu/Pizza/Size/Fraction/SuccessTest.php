...
class SizeFractionSuccess extends TestCase
{
    ...
    */
    ...
    {
        $response = $this->json('PUT', "restaurant/".$this->restaurant->id."/pizza/size/".$this->restaurant->id."/fraction/".$this->fractions[1]['id']."/exception", [
        ...
        $this->assertEquals($lastException->pizza_fraction_id, $this->fractions[1]['id']);
    }
